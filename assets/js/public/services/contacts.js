		...
		function ($stateProvider,   $urlRouterProvider) {
			$stateProvider
				...
				.state('contacts', {
					...
					// within index.html.
					templateUrl: '/app/contacts/contacts',
				...
				.state('contacts.list', {
					...
					templateUrl: '/app/contacts/contacts-list'
				})
				...
				.state('contacts.detail', {
					...
					views: {
						...
						'': {
							templateUrl: '/app/contacts/contacts-detail',
				...
				.state('contacts.detail.item', {
					...
					views: {
						...
						'': {
							templateUrl: 'app/contacts/contacts-detail-item',
				...
				.state('contacts.detail.item.edit', {
					views: {
						...
						'@contacts.detail': {
							templateUrl: '/app/contacts/contacts-detail-item-edit',
							controller: ['$scope', '$stateParams', '$state', 'utils',
								function (  $scope,   $stateParams,   $state,   utils) {
									$scope.item = utils.findById($scope.contact.items, $stateParams.itemId);
									$scope.done = function () {
